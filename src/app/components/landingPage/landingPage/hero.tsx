...
export default function Hero() {
    return(
        ...
        <div className="flex flex-row justify-between items-center px-6 md:px-36 min-h-screen">

        <div className="flex flex-col md:pt-24 gap-16 items-center light-rays">
        ...
        <div>           
        <div className="text-3xl md:text-8xl dark:text-zinc-100 uppercase text-zinc-800 font-primary font-bold leading-snug tracking-tight text-center">
            discover delicious recipes with just one click!
        </div>
        
        <div className="text-xs md:text-lg mt-12 md:mt-0 text-center font-secondary tracking-tight text-zinc-600 ">
